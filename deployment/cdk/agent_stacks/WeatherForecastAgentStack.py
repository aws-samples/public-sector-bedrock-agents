...
"""
This module defines the WeatherForecastAgentStack class for deploying an AWS CDK stack.
...
to retrieve weather forecasts and point coordinates.
"""
...
class WeatherForecastAgentStack(Stack):
    """
    Stack to deploy the Weather Forecast Agent Lambda function and associated resources.
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        lambda_function = PythonFunction(
            self,
            "WeatherForecastAgentFunction",
            runtime=Runtime.PYTHON_3_12,
            entry=os.path.join(current_dir, "..", "..", "..", "agent_tools", "WeatherForecastAgent", "lambda_functions"),
        ...
        with open(os.path.join(current_dir, "..", "..", "..", "agent_tools", "WeatherForecastAgent", "instructions", "instructions.txt"), 'r', encoding="utf-8") as file:
        ...
        agent = Agent(
            ...
            description="Provides a set of functions to retrieve weather forecasts and point coordinates.",
        ...
        action_group = AgentActionGroup(
            self,
            "WeatherForecastAG",
            action_group_name="WeatherForecastAG",
            description="Provides a set of functions to retrieve weather forecasts and point coordinates.",
            action_group_executor=executor_group,
            action_group_state="ENABLED",
            api_schema=ApiSchema.from_asset(os.path.join(current_dir, "..", "..", "..", "agent_tools", "WeatherForecastAgent", "schema", "openapi_schema.json")),
        )
        ...
        guardrail = Guardrail(self, 
                              "WeatherForecastGR",
                              name='WeatherForecastGR',
                              description="Weather Forecast Agent Guardrails.")
