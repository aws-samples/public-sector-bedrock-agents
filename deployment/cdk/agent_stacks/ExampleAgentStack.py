...
"""
This module defines the ExampleAgentStack class for deploying an AWS CDK stack
that sets up a example data interaction agent using AWS Bedrock and Lambda PowerTools.
"""
...
class ExampleAgentStack(Stack):
    """
    A stack for deploying the Example Agent using AWS CDK.
    ...
    def __init__(self, scope: Construct, construct_id: str, **kwargs) -> None:
        ...
        lambda_function = PythonFunction(
            self,
            "ExampleAgentFunction",
            runtime=Runtime.PYTHON_3_12,
            entry=os.path.join(current_dir, "..", "..", "..", "agent_tools", "ExampleAgent", "lambda_functions"),
        ...
        with open(os.path.join(current_dir, "..", "..", "..", "agent_tools", "ExampleAgent", "instructions", "instructions.txt"), 'r', encoding="utf-8") as file:
        ...
        agent = Agent(
            ...
            "ExampleAgent",
            name="ExampleAgent",
            description="Provides a set of functions to interact with example data.",
        ...
        action_group = AgentActionGroup(
            self,
            "ExampleAG",
            action_group_name="ExampleAG",
            description="Provides a set of functions to interact with example data.",
            action_group_executor=executor_group,
            action_group_state="ENABLED",
            api_schema=ApiSchema.from_asset(os.path.join(current_dir, "..", "..", "..", "agent_tools", "ExampleAgent", "schema", "openapi_schema.json")),
        )
        ...
        guardrail = Guardrail(self, 
                              "ExampleGR",
                              name='ExampleGR',
                              description= "Example Agent Guardrails.")
